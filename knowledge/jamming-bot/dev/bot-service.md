...
Это перекликается с замыслом [[jamming-bot/Jamming Bot|Jamming Bot]] как **агента без прикладной цели** — не индексатор ради поиска, не мониторинг SLA, не сбор контента под продукт. Он **не обязан быть полезным** в чужой экономике смысла; его «зачем» не зашито в требования к полезности, как у типичного бота. Философский фон формулы «смерти Бога» и свободы без внешнего гаранта смысла — в [[jamming-bot/narrative/Ницше — смерть Бога (заметка vault)|Ницше — смерть Бога]] и [[jamming-bot/narrative/Свобода и самоопределение (заметка vault)|Свобода и самоопределение]].
...
- [[jamming-bot/narrative/Ницше — смерть Бога (заметка vault)|Ницше — смерть Бога (заметка vault)]] — внешний гарант смысла и метафора для стека
- [[jamming-bot/narrative/Свобода и самоопределение (заметка vault)|Свобода и самоопределение (заметка vault)]] — свобода от / свобода к и самоопределение
