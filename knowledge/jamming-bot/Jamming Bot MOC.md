---
title: Jamming Bot MOC
note_type: moc
tags: [moc, jamming-bot]
description: Карта содержания проекта Jamming Bot в vault
---

# Jamming Bot — карта содержания
...
### Музыка, литература, философия пути
- [[Jamming bot музыкальная подборка]]
- [[Вырыпаев — Путь домой]] — отрывок из «Сахар»; «путь как самоцель»
- [[Voitenkov — Философия постмодерна (транскрипт лекции)]] — постмодерн (транскрипт лекции с YouTube)
- [[Ницше — смерть Бога (заметка vault)]], [[Свобода и самоопределение (заметка vault)]] — опорные карточки
...
- [[Jamming Bot — хронология автора]] — реконструкция фокуса автора по журналу и заметкам
- [[Jamming Bot — HUD старт Kubernetes]] — вымышленные строки HUD при подъёме кластера (Terminator / RoboCop)
- [[анализ/_index|Анализ — индекс]]
- [[анализ/Психологический портрет автора — кратко]]
- [[анализ/Психологический портрет автора — развернуто]]
- [[анализ/Operating Manual автора Jamming Bot]]
